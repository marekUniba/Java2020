...
/**
 * Jednoducha aplikacia s jednym namornikom, ktory chodi nahodne po kruhovom mole a utopi sa
 */
public class NamornikFx extends Application {
...
class NamornikCanvas extends Canvas {
    ...
    private Namornik namornik;

    public NamornikCanvas() {
        this.setWidth(sizeX);
        this.setHeight(sizeY);
        namornik = new Namornik(this);	// vytvorime vlakno pre namornika
...
class Namornik extends Thread {
    ...
    public Namornik(NamornikCanvas where) {
