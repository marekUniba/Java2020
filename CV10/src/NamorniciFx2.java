...
class NamornikFx2 extends Thread {
    ...
    public NamornikFx2(NamorniciCanvas where, boolean modry, int id, double x,
        ...
        synchronized (NamorniciFx2.class) {
...
class NamorniciCanvas extends Canvas {
    ...
    public synchronized void polohaNamornika(int id, PolohaFx p) {
        ...
        double vzdialenost = Math.sqrt((namorniciX[0] - namorniciX[1]) * (namorniciX[0] - namorniciX[1]) +
                (namorniciY[0] - namorniciY[1]) * (namorniciY[0] - namorniciY[1]));
...
public class NamorniciFx2 extends Application {
    @Override
