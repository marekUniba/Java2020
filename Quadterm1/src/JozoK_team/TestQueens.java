...
public class TestQueens {
    ...
    public void compareTo() {
        assertEquals("compareTo", 0,
                new Queens(new int[]{0, 1, 2, 3, 4})
                        .compareTo(
                                new Queens(new int[]{0, 1, 2, 3, 4})));
        assertEquals("compareTo", -1,
                new Queens(new int[]{0, 1, 2, 3, 4})
                        .compareTo(
                                new Queens(new int[]{0, 2, 1, 3, 4})));
        assertEquals("compareTo", -1,
                new Queens(new int[]{0, 1, 2, 3, 4})
                        .compareTo(
                                new Queens(new int[]{0, 1, 2, 4, 3})));
        assertEquals("compareTo", 1,
                new Queens(new int[]{0, 4, 2, 3, 1})
                        .compareTo(
                                new Queens(new int[]{0, 1, 2, 3, 4})));
        assertEquals("compareTo", 1,
                new Queens(new int[]{0, 1, 2, 4, 3})
    ...
    public void clockwise90() {
        ...
        int[] vysledok_q8_clockwise90 = {5, 2, 0, 7, 4, 1, 3, 6};
        assertArrayEquals("clockwise90",
        ...
        int[] vysledok_q8_3xclockwise90 = {1, 4, 6, 3, 0, 7, 5, 2};
