...
public class TestSpoluziaci {
    ...
    private static String[] alls() {
        List<String> l1 = Arrays.asList(testspoluziaci);
        List<String> l2 = Arrays.asList(testspoluziaciCelejSkoly);
        ArrayList<String>ll = new ArrayList<>();
        ll.addAll(l1);
        ll.addAll(l2);
        String[] alls = l1.toArray(new String[0]);
        return alls;
    }
    @Test
    public void testRozneMena() {
        assertArrayEquals("spoluziaci ",
                    myrozneMena(testspoluziaci).toArray(new String[0]),
                    Spoluziaci.rozneMena(testspoluziaci).toArray(new String[0]));
        assertArrayEquals("spoluziaciCelejSkoly ",
                myrozneMena(testspoluziaciCelejSkoly).toArray(new String[0]),
                Spoluziaci.rozneMena(testspoluziaciCelejSkoly).toArray(new String[0]));
        assertArrayEquals("ziadne ",
                myrozneMena(testziadne).toArray(new String[0]),
                Spoluziaci.rozneMena(testziadne).toArray(new String[0]));
        assertArrayEquals("jedno ",
                myrozneMena(testjedno).toArray(new String[0]),
                Spoluziaci.rozneMena(testjedno).toArray(new String[0]));
        assertArrayEquals("alls ",
                myrozneMena(alls()).toArray(new String[0]),
                Spoluziaci.rozneMena(alls()).toArray(new String[0]));
        scoring.updateScore("lang:common_list_test_scoring_name",30);
    }

    @Test
    public void testRozneMenaPodlaDlzky() {
        assertArrayEquals("spoluziaci ",
                myrozneMenaPodlaDlzky(testspoluziaci).toArray(new String[0]),
                Spoluziaci.rozneMenaPodlaDlzky(testspoluziaci).toArray(new String[0]));
        assertArrayEquals("spoluziaciCelejSkoly ",
                myrozneMenaPodlaDlzky(testspoluziaciCelejSkoly).toArray(new String[0]),
                Spoluziaci.rozneMenaPodlaDlzky(testspoluziaciCelejSkoly).toArray(new String[0]));
        assertArrayEquals("ziadne ",
                myrozneMenaPodlaDlzky(testziadne).toArray(new String[0]),
                Spoluziaci.rozneMenaPodlaDlzky(testziadne).toArray(new String[0]));
        assertArrayEquals("jedno ",
                myrozneMenaPodlaDlzky(testjedno).toArray(new String[0]),
                Spoluziaci.rozneMenaPodlaDlzky(testjedno).toArray(new String[0]));
        assertArrayEquals("alls ",
                myrozneMenaPodlaDlzky(alls()).toArray(new String[0]),
                Spoluziaci.rozneMenaPodlaDlzky(alls()).toArray(new String[0]));
        scoring.updateScore("lang:common_list_test_scoring_name", 30);
    }

    @Test
    public void Najcastejsie() {
        assertArrayEquals("spoluziaci ",
                mynajcastejsie(testspoluziaci).toArray(new String[0]),
                Spoluziaci.najcastejsie(testspoluziaci).toArray(new String[0]));
        assertArrayEquals("spoluziaciCelejSkoly ",
                mynajcastejsie(testspoluziaciCelejSkoly).toArray(new String[0]),
                Spoluziaci.najcastejsie(testspoluziaciCelejSkoly).toArray(new String[0]));
        assertArrayEquals("ziadne ",
                mynajcastejsie(testziadne).toArray(new String[0]),
                Spoluziaci.najcastejsie(testziadne).toArray(new String[0]));
        assertArrayEquals("jedno ",
                mynajcastejsie(testjedno).toArray(new String[0]),
                Spoluziaci.najcastejsie(testjedno).toArray(new String[0]));
        assertArrayEquals("alls ",
                mynajcastejsie(alls()).toArray(new String[0]),
                Spoluziaci.najcastejsie(alls()).toArray(new String[0]));
        scoring.updateScore("lang:common_list_test_scoring_name", 40);
    }

    //-----------------------

    public static List<String> myrozneMena(String[] mena) {
        return new ArrayList<>(new TreeSet<>(Arrays.asList(mena)));
    }
    public static List<String> myrozneMenaPodlaDlzky(String[] mena) {
        List<String> ls =  myrozneMena(mena);
    ...
    public static List<String> mynajcastejsie(String[] mena) {
    ...
    private static final String[] testziadne = { };
    private static final String[] testjedno = { "java" };

    private static final String[] testspoluziaci = {
    ...
    private static final String[] testspoluziaciCelejSkoly = {
